...
export const MinistryProjectsPage: React.FC = () => {
  ...
  const fetchProjects = async () => {
    ...
    try {
      ...
      setError("Unable to load national project records from database.");
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-slate-200 pb-4">
          <div>
            <div className="flex items-center gap-2">
              <span className="badge badge-info text-[10px] uppercase font-bold">NATIONAL PROJECT INTELLIGENCE</span>
              <span className="text-xs text-slate-500 font-mono">37,069 Ingested Projects</span>
            </div>
            <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight mt-0.5">
              National Project Intelligence
            </h1>
            <p className="text-xs text-slate-500">
              Macro monitoring across all Lok Sabha constituencies nationwide.
            </p>
          </div>
